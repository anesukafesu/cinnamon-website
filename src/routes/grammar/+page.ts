    ...
    return {
        rules: [
            ...
            },
            {
                ...
                explanationHtml: 'A statement is either a declare, input, output, set, if, while, run or return statement.'
            },
            {
                ruleHtml: `declare-statement = <strong>declare</strong> &lt;identifier&gt;*<strong>;</strong>`,
                explanationHtml: "The declare statement (used to declare local variables) begins with the 'declare' keyword, followed by zero or more identifiers. Each identifier represents the name of a variable being declared."
            },
            {
            ...
            {
                ruleHtml: 'output-statement = <strong>output</strong> &lt;output-data-type&gt; &lt;expression&gt;<strong>;</strong>',
                explanationHtml: "The output statement (used to display output using the runtime's standard output) begins with the 'output' keyword, followed by an output data type, then an expression whose value is to be displayed."
            },
            {
                ruleHtml: 'set-statement = <strong>set</strong> &lt;identifier&gt; <strong>=</strong> &lt;expression&gt;<strong>;</strong>',
                explanationHtml: "The set statement (used to assign a value to a variable) begins with with the 'set' keyword, followed by an identifier that identifies the variable where the value is to be stored, then an expression whose value is to be stored in the variable."
            },
            {
                ...
                explanationHtml: "The if statement begins with the keyword 'if', followed by an expression, then the keyword 'then'. This is followed by zero or more statements. Optionally, one can add an else clause by writing the 'else' keyword, followed by zero or more statements. There can only be one else clause. The if statement is terminated by the 'end' keyword."
            },
            {
                ruleHtml: `while-statement = <strong>while</strong> &lt;expression&gt; <strong>do</strong> &lt;statement&gt;* <strong>end</strong>`,
                explanationHtml: "The while statement begins with the keyword 'while', followed by an expression, then the keyword do. This is followed by zero or more statements that form the body of the loop. Then you terminate the statement with the 'end' keyword."
            },
            {
                ruleHtml: `run-statement = <strong>run</strong> &lt;identifier&gt; <strong>(</strong> &lt;expression&gt;* <strong>);</strong>`,
                explanationHtml: "The run statement begins with the keyword 'run', followed by an identifier that represents the name of the function that is to be executed, then open parentheses, zero or more expressions as arguments to the function, then lastly, close parentheses and a semi-colon."
            },
            {
                ruleHtml: `return-statement = <strong>return</strong> &lt;expression&gt;;`,
                explanationHtml: "The return statement begins with the keyword return, followed by an expression and a semi-colon."
            },
            {
